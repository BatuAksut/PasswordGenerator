...
namespace PasswordGenerator
{
  public static class PasswordGenerator
  {
    ...
    // FIXME: there are too many functions to generate a password.
    // We can rethink of this method by making it a one-size-fits-all function.
    // It can accept the length and the character pool to be used. Keep the sanity checks outside of this.
    // [Q]: why did you use a "static" function? Is there any specific reason?
    public static void GenerateDefaultPassword(int? length = null, string? without = null)
    {
      ...
      {
        // FIXME: put these string literals as constants. In a separate file? Where it makes more sense.
        case "lower":
